...
class MemoryPolicyConfig:
    ...
    on_hard_limit: str = "unload_models"
...
def _load_policy_config() -> MemoryPolicyConfig:
    try:
        ...
        return MemoryPolicyConfig(
            soft_gb=float(gpu.get("soft_memory_limit_gb", 90)),
            hard_gb=float(gpu.get("hard_memory_limit_gb", 100)),
            ...
            on_hard_limit=str(gpu.get("on_hard_limit", "unload_models")),
